...
<body id="page-top">
    <nav class="navbar navbar-light navbar-expand-lg fixed-top bg-secondary text-uppercase" id="mainNav">
        <div class="container"><a class="navbar-brand js-scroll-trigger" href="#page-top"><img class="img-fluid" src="assets/img/Logo%20Klinik%20Berkah%20fix.jpg" style="width: 50px;height: 50px;margin: 5px;">klinik berkah abadi medika</a><button data-toggle="collapse" data-target="#navbarResponsive"
            ...
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item mx-0 mx-lg-1" role="presentation"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="Login.html">Login</a></li>
                </ul>
            </div>
        </div>
    </nav>
    <section id="portfolio" class="portfolio">
        <div class="container full-height">
            <div class="row register-form">
                <div class="col">
                    <form class="custom-form" style="background-color: rgb(249,247,247);margin-right: 250px;margin-left: 250px;margin-top: 40px;"><img class="img-fluid" src="assets/img/Logo%20Klinik%20Berkah%20fix.jpg" style="width: 50px;height: 50px;margin: 5px;">
                        <h1>Login Form</h1>
                        ...
                        </div><a class="btn btn-light submit-button" role="button" href="index.html">Login</a></form>
                </div>
            </div>
        </div>
    </section>
